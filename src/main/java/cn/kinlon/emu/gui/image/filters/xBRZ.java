...
public final class xBRZ extends VideoFilter {
    ...
    private enum Rot {
        ...
        public static final int[] R = new int[9 * 4];
    ...
    public static class ScalerCfg {
        ...
        public final double luminanceWeight = 1;
        public final double equalColorTolerance = 30;
        public final double dominantDirectionThreshold = 3.6;
        public final double steepDirectionThreshold = 2.2;
    }
