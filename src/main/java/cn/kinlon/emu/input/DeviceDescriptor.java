...
import cn.kinlon.emu.input.arkanoid.ArkanoidDescriptor;
import cn.kinlon.emu.input.bandaihypershot.BandaiHyperShotDescriptor;
import cn.kinlon.emu.input.barcodebattler.BarcodeBattlerDescriptor;
import cn.kinlon.emu.input.battlebox.BattleBoxDescriptor;
import cn.kinlon.emu.input.crazyclimber.CrazyClimberLeftDescriptor;
import cn.kinlon.emu.input.crazyclimber.CrazyClimberRightDescriptor;
import cn.kinlon.emu.input.dongda.DongdaPEC586KeyboardDescriptor;
import cn.kinlon.emu.input.doremikkokeyboard.DoremikkoKeyboardDescriptor;
import cn.kinlon.emu.input.excitingboxing.ExcitingBoxingDescriptor;
import cn.kinlon.emu.input.familybasic.datarecorder.DataRecorderDescriptor;
import cn.kinlon.emu.input.familybasic.keyboard.KeyboardDescriptor;
import cn.kinlon.emu.input.familybasic.transformer.TransformerDescriptor;
import cn.kinlon.emu.input.familytrainermat.FamilyTrainerMatDescriptor;
import cn.kinlon.emu.input.gamepad.Gamepad1Descriptor;
import cn.kinlon.emu.input.gamepad.Gamepad2Descriptor;
import cn.kinlon.emu.input.gamepad.Gamepad3Descriptor;
import cn.kinlon.emu.input.gamepad.Gamepad4Descriptor;
import cn.kinlon.emu.input.glasses.GlassesDescriptor;
import cn.kinlon.emu.input.horitrack.HoriTrackDescriptor;
import cn.kinlon.emu.input.konamihypershot.KonamiHyperShotDescriptor;
import cn.kinlon.emu.input.mahjong.MahjongDescriptor;
import cn.kinlon.emu.input.miraclepiano.MiraclePianoDescriptor;
import cn.kinlon.emu.input.none.NoneDescriptor;
import cn.kinlon.emu.input.oekakids.OekaKidsDescriptor;
import cn.kinlon.emu.input.pachinko.PachinkoDescriptor;
import cn.kinlon.emu.input.partytap.PartyTapDescriptor;
import cn.kinlon.emu.input.powerglove.PowerGloveDescriptor;
import cn.kinlon.emu.input.powerpad.PowerPadDescriptor;
import cn.kinlon.emu.input.racermate.RacerMate1Descriptor;
import cn.kinlon.emu.input.racermate.RacerMate2Descriptor;
import cn.kinlon.emu.input.snesmouse.SnesMouseDescriptor;
import cn.kinlon.emu.input.subor.SuborDescriptor;
import cn.kinlon.emu.input.taptapmat.TapTapMatDescriptor;
import cn.kinlon.emu.input.topriderbike.TopRiderBikeDescriptor;
import cn.kinlon.emu.input.turbofile.TurboFileDescriptor;
import cn.kinlon.emu.input.uforce.UForceDescriptor;
import cn.kinlon.emu.input.zapper.ZapperDescriptor;
