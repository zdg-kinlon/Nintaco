...
public final class Emu2149 {
    ...
    public static final void PSG_set_rate(final PSG psg, final int r) {
        psg.rate = (r != 0) ? r : 44100;
        internal_refresh(psg);
    }

    public static final void PSG_set_quality(final PSG psg, final boolean q) {
        psg.quality = q;
        internal_refresh(psg);
    }

    public static final PSG PSG_new(final int c, final int r) {
        PSG psg = new PSG();
    ...
    public static final void PSG_setVolumeMode(final PSG psg, final int type) {
        switch (type) {
            case 1:
    ...
    public static final int PSG_setMask(final PSG psg, final int mask) {
        int ret = 0;
        if (psg != null) {
            ret = psg.mask;
            psg.mask = mask;
    ...
    public static final int PSG_toggleMask(final PSG psg, final int mask) {
        int ret = 0;
        if (psg != null) {
            ret = psg.mask;
            psg.mask ^= mask;
    ...
    public static final void PSG_reset(final PSG psg) {
    ...
    public static final void PSG_delete(final PSG psg) {
    }

    public static final int PSG_readIO(final PSG psg) {
        return psg.reg[psg.adr];
    }

    public static final int PSG_readReg(final PSG psg, final int reg) {
        return psg.reg[reg & 0x1f];
    }

    public static final void PSG_writeIO(final PSG psg, final int adr,
                                         final int val) {
        if ((adr & 1) != 0) {
    ...
    private static final int calc(final PSG psg) {
    ...
    public static final int PSG_calc(final PSG psg) {
        if (!psg.quality) {
            return calc(psg) << 4;
        }
    ...
    public static final void PSG_writeReg(final PSG psg, final int reg,
                                          final int val) {
