...
import static cn.kinlon.emu.cpu.Interrupt.*;
import static cn.kinlon.emu.cpu.Interrupt.IRQ_DMC;
import static cn.kinlon.emu.mappers.Mapper.REG_INPUT_PORT_1;
import static cn.kinlon.emu.mappers.Mapper.REG_INPUT_PORT_2;
...
import static cn.kinlon.emu.utils.MathUtil.isOdd;
...
public class CPU implements Serializable {
    ...
    public void setNMI(final boolean value) {
        irt.nmiRequested(value);
    }

    public void setMapperIrq(final boolean value) {
        irt.irqRequested(setBit(irt.irqRequested(), IRQ_MAPPER, value));
    }

    public boolean getMapperIrq() {
        return getBitBool(irt.irqRequested(), IRQ_MAPPER);
    }

    public void setApuIrq(final boolean value) {
        irt.irqRequested(setBit(irt.irqRequested(), IRQ_APU, value));
    }

    public boolean getApuIrq() {
        return getBitBool(irt.irqRequested(), IRQ_APU);
    }

    public void setDmcIrq(final boolean value) {
        irt.irqRequested(setBit(irt.irqRequested(), IRQ_DMC, value));
    }

    public boolean getDmcIrq() {
        return getBitBool(irt.irqRequested(), IRQ_DMC);
    }
    ...
    public int getInstructionsCounter() {
        return state.instructionsCounter();
    }
}